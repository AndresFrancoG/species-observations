...
# species_observations documentation build
...
from species_observations import __version__ as release

# -- Project information -----------------------------------------------------

project = "species_observations"
author = "Kedro"
...
htmlhelp_basename = "species_observationsdoc"
...
latex_documents = [
    (
        master_doc,
        "species_observations.tex",
        "species_observations Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "species_observations",
        "Project species_observations codebase.",
        "Data-Science",
    )
]
